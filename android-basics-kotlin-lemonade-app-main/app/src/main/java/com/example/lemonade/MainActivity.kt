...
class MainActivity : AppCompatActivity() {
    ...
    private fun clickLemonImage() {
        ...
        if (lemonadeState == SELECT){
            ...
            if (squeezeCount > 1) { squeezeCount-- }
    ...
    private fun setViewElements() {
        ...
        var drawableResource = R.drawable.lemon_drink
        var textResource = R.string.lemon_drink
        ...
        textAction.setText(textResource).toString()
